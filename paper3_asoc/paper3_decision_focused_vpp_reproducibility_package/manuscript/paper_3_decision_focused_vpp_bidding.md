...
Decision metrics: total revenue, average daily profit, regret against hindsight optimum, imbalance penalty, downside revenue, CVaR, loss days, and risk-adjusted return [1], [2], [6]. Forecasting metrics should still be reported but should not dominate the paper.
